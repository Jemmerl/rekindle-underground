...
public class RKUndergroundConfig {
    ...
    {
        private static final int REGION_SIZE = 128; // Rough average, in chunks
        private static final double REGIONAL_VARIATION = 0.50; // 0.00 - 1.00 scale
        private static final int FAULT_SIZE = 64; // Rough average, in chunks
        private static final double FAULT_VARIATION = 0.20; // 0.00 - 1.00 scale; 0 is no fault shift
        private static final double STRATA_DEPTH = 0.60; // 0.00 - 1.00 scale; 0 is very thin, 1 is essentially solid regions
        ...
        public final ForgeConfigSpec.ConfigValue<Double> strataDepth;
        ...
        public Common(ForgeConfigSpec.Builder builder)
        {
            ...
            this.strataDepth = builder.comment("Sets the general range of depth for strata layers; Recommended Default is 0.60")
                    .worldRestart()
                    .defineInRange("Strata Depth", STRATA_DEPTH, 0.0, 1.0);
            builder.pop();
        }
    }
