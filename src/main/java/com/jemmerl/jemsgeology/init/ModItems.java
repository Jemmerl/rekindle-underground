...
//
//    public static final RegistryObject<Item> COLTAN_ORE = registerOreItem(OreType.COLTAN);
//    public static final RegistryObject<Item> POOR_COLTAN_ORE = registerPoorOreItem(OreType.COLTAN);
//
