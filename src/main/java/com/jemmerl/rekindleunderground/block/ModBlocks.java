...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> CHALK = registerBlock("chalk_stone",
            () -> new StoneOreBlock(AbstractBlock.Properties.create(Material.ROCK)
                    .harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(HARDS[0], RESISTS[0]), StoneType.SEDIMENTARY), 64);

    public static final RegistryObject<Block> LIMESTONE = registerBlock("limestone_stone",
            () -> new StoneOreBlock(AbstractBlock.Properties.create(Material.ROCK)
                    .harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(HARDS[1], RESISTS[1]), StoneType.SEDIMENTARY), 64);

    public static final RegistryObject<Block> DOLOSTONE = registerBlock("dolostone_stone",
            () -> new StoneOreBlock(AbstractBlock.Properties.create(Material.ROCK)
                    .harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(HARDS[2], RESISTS[2]), StoneType.SEDIMENTARY), 64);
    ...
    public static final RegistryObject<Block> VEIN_QUARTZ = registerBlock("veinquartz_stone",
            () -> new StoneOreBlock(AbstractBlock.Properties.create(Material.ROCK)
                    .harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(HARDS[4], RESISTS[4]), StoneType.SEDIMENTARY), 64);

    // Igneous Extrusive Stones
    public static final RegistryObject<Block> RHYOLITE = registerBlock("rhyolite_stone",
            () -> new StoneOreBlock(AbstractBlock.Properties.create(Material.ROCK)
                    .harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(HARDS[2], RESISTS[2]), StoneType.EXTRUSIVE), 64);

    public static final RegistryObject<Block> DACITE = registerBlock("dacite_stone",
            () -> new StoneOreBlock(AbstractBlock.Properties.create(Material.ROCK)
                    .harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(HARDS[3], RESISTS[3]), StoneType.EXTRUSIVE), 64);
    ...
    public static final RegistryObject<Block> DIORITE = registerBlock("diorite_stone",
            () -> new StoneOreBlock(AbstractBlock.Properties.create(Material.ROCK)
                    .harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(HARDS[4], RESISTS[4]), StoneType.INTRUSIVE), 64);
    ...
    public static final RegistryObject<Block> PERIDOTITE = registerBlock("peridotite_stone",
            () -> new StoneOreBlock(AbstractBlock.Properties.create(Material.ROCK)
                    .harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(HARDS[3], RESISTS[3]), StoneType.INTRUSIVE), 64);

    // Metamorphic Stones
    public static final RegistryObject<Block> QUARTZITE = registerBlock("quartzite_stone",
            () -> new StoneOreBlock(AbstractBlock.Properties.create(Material.ROCK)
                    .harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(HARDS[4], RESISTS[4]), StoneType.METAMORPHIC), 64);

    public static final RegistryObject<Block> SCHIST = registerBlock("schist_stone",
            () -> new StoneOreBlock(AbstractBlock.Properties.create(Material.ROCK)
                    .harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(HARDS[1], RESISTS[1]), StoneType.METAMORPHIC), 64);

    public static final RegistryObject<Block> PHYLLITE = registerBlock("phyllite_stone",
            () -> new StoneOreBlock(AbstractBlock.Properties.create(Material.ROCK)
                    .harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(HARDS[2], RESISTS[2]), StoneType.METAMORPHIC), 64);
    ...
    public static final RegistryObject<Block> MARBLE = registerBlock("marble_stone",
            () -> new StoneOreBlock(AbstractBlock.Properties.create(Material.ROCK)
                    .harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(HARDS[3], RESISTS[3]), StoneType.METAMORPHIC), 64);
