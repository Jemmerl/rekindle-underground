...
import com.jemmerl.jemsgeology.geology.strata.BlockPicker;
...
//            blockState = UtilMethods.stringToBlockState("jemsgeology:sandstone_stone");
//        }
//        if (original.getBlock().equals(Blocks.RED_SANDSTONE)) {
//            blockState = UtilMethods.stringToBlockState("jemsgeology:red_sandstone_stone");
//        }
