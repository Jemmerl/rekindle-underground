...
Jem's Geology is a mod originally developed by Jemmerl (and with direct and in-direct help from countless others)
for use in the modpack: Rekindle. Originally called "Rekindle Underground", it has been renamed to reflect its now
more general focus.

IT IS IN DEVELOPMENT, AND MANY FEATURES ARE INCOMPLETE OR NOT YET IMPLEMENTED!
MUCH IS POORLY CODED AND WOULD LIKELY BREAK OUTSIDE A DEV ENVIROMENT IF NOT USED EXACTLY AS INTENDED.

Jem's Geo was created out of the want for a realistic yet still highly configurable geological generation mod.
It is currently mainly for use within the in-dev Rekindle modpack, but is being worked on to eventually be suitable
...
any such desires are possible! Any parameter such as the rock-set of regions that generate to how each region's strata
behaves is 100% configurable. As little as possible is hard coded!
...
underground activities are meant to be "difficult-difficult-lemon-difficult"! Even worse, starting at Y-Level 50,
the stones get harder and harder to mine. Both of these features are completely configurable.
